...
-- Thriller movies is in top 3 among all genres in terms of number of movies In the previous segment,
--  you analysed the movies and ge nres tables. In this segment, you will analyse the ratings table as well.
...
-- Top 2 actors are Vijay Sethupathi and Fahaad Faasil
